    ...
    <div class="col-md-12"> 
      <div id="accordion"> 
	   <?php
		...
		<a class="collapsed card-link" data-toggle="collapse" href="#collapseOne<?php echo $sub->id; ?>"><?php echo $sub->name; ?></a> 
			...
			?>
			  <div class="item"> 
				<div class="testimonials-box"> 
				  ...
				  <div class="name-box"> 
					<div class="name-img"><img src="<?php echo ASSETS;?>frontend/images/user-big.png" alt="" class="img-fluid" /></div> 
					<div class="name-text"> 
				 ...
				 <div class="item">
				   <div class="consulting-img">
                                ...
                                <div class="consulting-img-text hover-info">
                                    <h6><?php echo $service->name; ?></h6>
                                    <!-- <span>IT Networking</span> -->
                                    <p><?php echo $service->short_descpription; ?></p>
                                    <a href="<?php echo BASE_URL ?>services/detail/<?php echo $service->url; ?>" class="find-text tc-orange_red bg-sapphire"><i
