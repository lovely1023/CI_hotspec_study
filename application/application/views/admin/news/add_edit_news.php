	<script language="Javascript" src="<?php echo base_url(); ?>editor/scripts/innovaeditor.js"></script>
		<div class="container-fluid">
				<h3 class="mt-4">News </h3>
					...
					<div class="card mb-4">
					 <div class="card-body">
						<form role="form" class="form-horizontal form-groups-bordered validate" method="post" action="<?php echo ADMIN_URL;?>news/save" enctype="multipart/form-data">
							...
							<div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">									
											<input type="text" class="form-control" id="title" value="<?php echo $news->title;?>" name="title" placeholder="Title" required>
									</div>
								</div>
							</div>	
                            <div class="form-group">
							   <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">
										...
										{
										?>	
											<option value="<?php echo $category->id ?>" <?php echo ($news->category_id==$category->id)?'selected="selected"':'';?>><?php echo $category->name ?>
											</option>
										<?php
										}
										?>
								   ...
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">
										<select class="form-control" id="is_popular" name="is_popular">
											<option value="1"  <?php echo ($news->is_popular==1)?'selected="selected"':'';?>>Yes</option>
											<option value="0" <?php echo ($news->is_popular==0)?'selected="selected"':'';?>>No</option>
							  ...
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									{
									?>
									<img src="<?php echo ASSETS.'upload/news/'.$news->image;?>" height="75" width="75">
									<?php
								   ...
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">
										<select class="form-control" id="status" name="status">
											<option value="0" <?php echo ($news->status==0)?'selected="selected"':'';?>>Inactive</option>
											<option value="1"  <?php echo ($news->status==1)?'selected="selected"':'';?>>Active</option>
										</select>
									</div>
								</div>
							  </div>
						  ...
						  <div class="form-group">				
						   ...
						   <div class="col-sm-8">	
						   <textarea class="form-control" name="short_description" id="short_description"><?php echo $news->short_description;?></textarea>	 
						    <script>
					     ...
					     <div class="form-group">				
						   ...
						   <div class="col-sm-8">	
						   <textarea class="form-control" name="description" id="description"><?php echo $news->description;?></textarea>	 <script>
