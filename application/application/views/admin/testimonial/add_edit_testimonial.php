	<script language="Javascript" src="<?php echo base_url(); ?>editor/scripts/innovaeditor.js"></script>
		<div class="container-fluid">
				<h3 class="mt-4">Testimonial </h3>
					...
					<div class="card mb-4">
					 <div class="card-body">
						<form role="form" class="form-horizontal form-groups-bordered validate" method="post" action="<?php echo ADMIN_URL;?>testimonial/save" enctype="multipart/form-data">
							...
							<div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">										
											<input type="text" class="form-control" id="title" value="<?php echo $testimonial->title;?>" name="title" placeholder="Title" aria-required="true" data-validate="required">
									</div>
								</div>
							</div>
							 <div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									{
									?>
									<img src="<?php echo ASSETS.'upload/'.$testimonial->image;?>" height="75" width="75">
									<?php
						  ...
						  <div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									<div class="col-sm-6">
									<?php
									if($testimonial->bottom_image!='')
									{
									?>
									<img src="<?php echo ASSETS.'upload/'.$testimonial->bottom_image;?>" height="75" width="75">
									<?php
						  ...
						  <div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									{
									?>
									<img src="<?php echo ASSETS.'upload/'.$testimonial->screenshot;?>" height="75" width="75">
									<?php
							...
							<div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">										
											<input type="text" class="form-control" id="user_name" value="<?php echo $testimonial->user_name;?>" name="user_name" required>
									</div>
								</div>
							</div>						
							  ...
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">										
											<input type="text" class="form-control" id="designation" value="<?php echo $testimonial->designation ;?>" name="designation" required>
									</div>
								</div>
							</div>
							<div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">										
											<input type="text" class="form-control" id="star" value="<?php echo $testimonial->star ;?>" name="star" required>
									</div>
								</div>
							</div>						
								   ...
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">
										<select class="form-control" id="status" name="status">
											<option value="0" <?php echo ($testimonial->status==0)?'selected="selected"':'';?>>Inactive</option>
											<option value="1"  <?php echo ($testimonial->status==1)?'selected="selected"':'';?>>Active</option>
										</select>
									</div>
								</div>
							  </div>
					     ...
					     <div class="form-group">				
						   ...
						   <div class="col-sm-8">	
						   <textarea class="form-control" name="description" id="description"><?php echo $testimonial->description;?></textarea>	 <script>
