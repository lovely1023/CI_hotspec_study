	<script language="Javascript" src="<?php echo base_url(); ?>editor/scripts/innovaeditor.js"></script>
		<div class="container-fluid">
				<h3 class="mt-4">Career Prospects </h3>
					...
					<div class="card mb-4">
					 <div class="card-body">
						<form role="form" class="form-horizontal form-groups-bordered validate" method="post" action="<?php echo ADMIN_URL;?>careerprospects/save" enctype="multipart/form-data">
							...
							<div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">										
											<input type="text" class="form-control" id="title" value="<?php echo $careerprospects->title;?>" name="title" placeholder="Title" aria-required="true" data-validate="required">
									</div>
								</div>
							</div>
							 <div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									<div class="col-sm-6">
									<?php
									if($careerprospects->image!='')
									{
									?>
									<img src="<?php echo ASSETS.'upload/'.$careerprospects->image;?>" height="75" width="75">
									<?php
								   ...
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">
										<select class="form-control" id="status" name="status">
											<option value="0" <?php echo ($careerprospects->status==0)?'selected="selected"':'';?>>Inactive</option>
											<option value="1"  <?php echo ($careerprospects->status==1)?'selected="selected"':'';?>>Active</option>
										</select>
									</div>
								</div>
							  </div>
					     ...
					     <div class="form-group">				
						   ...
						   <div class="col-sm-8">	
						   <textarea class="form-control" name="description" id="description"><?php echo $careerprospects->description;?></textarea>	 <script>
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-5">
								    <input type="hidden" name="id" id="id" value="<?php echo $careerprospects->id;?>">
