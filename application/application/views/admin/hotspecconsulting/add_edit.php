   ...
   <h3 class="mt-4">Hotspec consulting </h3>
	<ol class="breadcrumb mb-4">
		...
		?>
      	<div class="card mb-4">
					 <div class="card-body">
						<form role="form" class="form-horizontal form-groups-bordered validate" method="post" action="<?php echo ADMIN_URL;?>hotspecconsulting/save" enctype="multipart/form-data">
							...
							<div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">										
											<input type="text" class="form-control" id="name" value="<?php echo $hotspecconsulting->name;?>" name="name" placeholder="name" aria-required="true" data-validate="required">
									</div>
								</div>
							</div>	
                         ...
                         <div class="form-group">
							   <div class="col-sm-12">
								   <div class="col-sm-4">
										<label for="field-2" class="control-label">Parent Consulting</label>
									</div>
									<div class="col-sm-8">
										<select class="form-control" id="parent_id" name="parent_id">
										  ...
										  foreach($hotspecconsultings as $const)
										  {
											  if($const->id ==$id)
											  {
												  continue;
										  ...
										  ?>
											<option value="<?php echo $const->id ?>" <?php echo ($hotspecconsulting->parent_id==$const->id)?'selected="selected"':'';?>><?php echo $const->name ?></option>
										<?php
							...
							<div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">										
											<input type="text" class="form-control" id="role" value="<?php echo $hotspecconsulting->role;?>" name="role" aria-required="true" data-validate="required">
									</div>
								</div>
							</div>
						...
						<div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">										
											<input type="text" class="form-control" id="url" value="<?php echo $hotspecconsulting->url;?>" name="url" aria-required="true" data-validate="required">
									</div>
								</div>
						</div>		
						 ...
						 <div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									<div class="col-sm-6">
									<?php
									if($hotspecconsulting->image!='')
									{
									?>
									<img src="<?php echo ASSETS.'upload/'.$hotspecconsulting->image;?>" height="75" width="75">
									<?php
						   ...
						   <div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
										<label for="field-1" class="ccontrol-label">Services Brochure</label>
									</div>
									<div class="col-sm-8">
									<div class="col-sm-6">
										<input type="file" class="form-control" id="services_brochure"  name="services_brochure">										
									</div>
									<div class="col-sm-6">
									<?php
									if($hotspecconsulting->services_brochure!='')
									{
									?>
									<a href="<?php echo ASSETS.'upload/'.$hotspecconsulting->services_brochure;?>" target="_blank">View</a>
						...
						<!--  <div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
										<label for="field-1" class="ccontrol-label">Business Consultation</label>
									</div>
									<div class="col-sm-8">
									<div class="col-sm-6">
										<input type="file" class="form-control" id="business_consultation"  name="business_consultation">										
									</div>
									<div class="col-sm-6">
									<?php
									if($hotspecconsulting->business_consultation!='')
									{
									?>
									<a href="<?php //echo ASSETS.'upload/'.$hotspecconsulting->business_consultation;?>" target="_blank">View</a>
                         ...
                         <div class="form-group">
							  <div class="col-sm-12">
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">										
											<textarea class="form-control" id="short_descpription" name="short_descpription"  aria-required="true" data-validate="required"><?php echo $hotspecconsulting->short_descpription;?></textarea>
									</div>
								</div>
							</div>						  
						 ...
						 <div class="form-group">				
						   ...
						   <div class="col-sm-8">	
						   <textarea class="form-control" name="description" id="description"><?php echo $hotspecconsulting->description;?></textarea>	
						   <script>
								   ...
								   <div class="col-sm-4">
									...
									<div class="col-sm-8">
										<select class="form-control" id="status" name="status">
											<option value="0" <?php echo ($hotspecconsulting->status==0)?'selected="selected"':'';?>>Inactive</option>
											<option value="1"  <?php echo ($hotspecconsulting->status==1)?'selected="selected"':'';?>>Active</option>
										</select>
									</div>
								</div>
							  </div>
							...
							$tabdescription= unserialize($hotspecconsulting->tabdescription);
							$tabtitle=array();
							$tabdesc=array();
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-5">
								    <input type="hidden" name="id" id="id" value="<?php echo $hotspecconsulting->id;?>">
...
$("#add-more-tab").on("click", function(){
			 ...
			 html		+=	'<div class="col-sm-8" ><textarea class="form-control" id="tabdescription2" name="tabdescription[tabdescription][]"></textarea></div>';
