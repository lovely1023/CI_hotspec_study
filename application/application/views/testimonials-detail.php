				...
				<div class="col-md-8">
					<div class="succes-detail-project">
						<div class="project-manag">
							<img src="<?php echo ASSETS;?>upload/<?php echo $testimonial->image; ?>" alt="">
						</div>
						...
						<div class="screen-short">
							<img src="<?php echo ASSETS;?>upload/<?php echo $testimonial->screenshot; ?>" alt="">
						</div>
					</div>
				</div>
				<div class="col-md-4">
				 ...
				 $i=1;
					 foreach($testimonials as $story)
					  {
						 if($story->id== $testimonial->id) 
						 {
							 continue;
						 }
					   ?>
						<a href="<?php echo BASE_URL ?>testimonials/detail/<?php echo $story->id; ?>" class="success-side-project">
